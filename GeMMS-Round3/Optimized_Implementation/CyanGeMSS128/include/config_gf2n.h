...
#if (defined(__TRINOMIAL_GF2N__)&&defined(__PENTANOMIAL_GF2N__))||\
  (!(defined(__TRINOMIAL_GF2N__)||defined(__PENTANOMIAL_GF2N__)))
...
(HFEn!=358) && (HFEn!=402) )
    ...
    #if (((HFEn!=312)&&(HFEn!=448)&&(HFEn!=544)&&(K3>32))||((HFEn==448)&&\
(K3>64))||((HFEn==312)&&(K3!=128)&&(K2!=15)&&(K1!=5))||\
((HFEn==544)&&(K3!=128)&&(K2!=3)&&(K1!=1)))
        #error "The modular reduction does not support K3>32"
    #endif
#endif
