...
/* #define RedGeMSS */
/* To choose parameters of WhiteGeMSS */
/* #define WhiteGeMSS */
/* To choose parameters of CyanGeMSS */
/* #define CyanGeMSS */
/* To choose parameters of MagentaGeMSS */
/* #define MagentaGeMSS */
...
/** Choice of a HFE-based multivariate scheme. */
     ...
     defined(WhiteGeMSS)||defined(CyanGeMSS)||defined(MagentaGeMSS)||\
...
/** Prefix which is the name of the current used cryptosystem. */
    ...
    #define CRYPTO_NAME WhiteGeMSS_
#elif defined(CyanGeMSS)
    #define CRYPTO_NAME CyanGeMSS_
#elif defined(MagentaGeMSS)
    #define CRYPTO_NAME MagentaGeMSS_
#elif defined(FGeMSS)
